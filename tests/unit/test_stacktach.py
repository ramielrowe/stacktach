...
class StacktachRawParsingTestCase(unittest.TestCase):
    ...
    def test_process_raw_data(self):
        ...
        self.mox.StubOutWithMock(views, "aggregate")
        views.aggregate(raw)
        self.mox.ReplayAll()
...
class StacktachLifecycleTestCase(unittest.TestCase):
    ...
    def test_aggregate_no_instance(self):
        raw = self.mox.CreateMockAnything()
        raw.instance = None
        self.mox.ReplayAll()
        views.aggregate(raw)
